...
export const BUTTON_COLORS: Record<Exclude<ColorVariant, 'custom'>, string> = {
  primary: '#3b82f6',
  secondary: '#6b7280',
  success: '#10b981',
  error: '#ef4444',
...
export const BUTTON_SIZES: Record<ComponentSize, { padding: string; fontSize: string; height: string }> = {
...
export const BUTTON_ROUNDED: Record<BorderRadius, string> = {
  none: '0',
  sm: '0.25rem',
  md: '0.375rem',
  lg: '0.5rem',
...
export const BUTTON_ELEVATION: Record<number, string> = {
  0: 'none',
